...
const std::unordered_map<std::string, Entry>& table() {
    static const std::unordered_map<std::string, Entry> t = {
        ...
        {"cmd_add_usage", {"❌ Usage: /add 0x... Name", "❌ Использование: /add 0x... Имя"}},
        {"cmd_add_name_too_long", {"❌ Name is too long (max 32 characters)", "❌ Имя слишком длинное (макс. 32 символа)"}},
        {"cmd_add_wallet_added", {"✅ Wallet added:", "✅ Кошелёк добавлен:"}},
        {"cmd_add_bad_address", {"❌ That doesn't look like a valid address (expected 0x + 40 hex characters)",
                                 "❌ Похоже, это не тот формат адреса (ожидается 0x + 40 hex-символов)"}},
        {"cmd_remove_removed", {"✅ Wallet removed", "✅ Кошелёк удалён"}},
        {"cmd_remove_not_found", {"⚠️ Address not found in your list. Check /mywallets",
                                  "⚠️ Адрес не найден в вашем списке. Проверьте /mywallets"}},
        {"cmd_limit_positive", {"❌ Threshold must be positive", "❌ Порог должен быть положительным"}},
        {"cmd_limit_set", {"✅ Threshold set to $", "✅ Порог установлен: $"}},
        {"cmd_limit_usage", {"❌ Usage: /limit 5000", "❌ Использование: /limit 5000"}},
        {"cmd_language_usage", {"❌ Usage: /language en (supported: en, ru)", "❌ Использование: /language ru (доступно: en, ru)"}},
        {"unknown_command", {"🤔 Unknown command. Try /help or use the menu below.",
                             "🤔 Неизвестная команда. Попробуйте /help или используйте меню ниже."}},
        ...
        {"help_commands", {"<b>Commands:</b>", "<b>Команды:</b>"}},
        {"help_cmd_top", {"/top — Open TOP Traders", "/top — Открыть Топ трейдеров"}},
        {"help_cmd_premium", {"/premium — View Premium plans", "/premium — Тарифы Премиум"}},
        {"help_cmd_add", {"/add &lt;wallet&gt; &lt;name&gt; — Track a wallet", "/add &lt;кошелёк&gt; &lt;имя&gt; — Отслеживать кошелёк"}},
        {"help_cmd_remove", {"/remove &lt;wallet&gt; — Remove a wallet", "/remove &lt;кошелёк&gt; — Удалить кошелёк"}},
        {"help_cmd_mywallets", {"/mywallets — My tracked wallets", "/mywallets — Мои отслеживаемые кошельки"}},
        {"help_cmd_limit", {"/limit &lt;USD&gt; — Set minimum alert amount", "/limit &lt;USD&gt; — Задать минимальную сумму алерта"}},
