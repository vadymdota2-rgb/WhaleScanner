...
const std::unordered_map<std::string, Entry>& table() {
    static const std::unordered_map<std::string, Entry> t = {
        ...
        {"hold_choose", {"Choose a wallet to see what it is holding right now:",
                         "Выберите кошелёк, чтобы посмотреть, что в нём сейчас:"}},
        ...
        {"pr_active_benefits", {"You have access to tracking up to 50 wallets and the full Top 100 Traders list.",
                                "Вам доступно: отслеживание до 50 кошельков и полный Топ-100 трейдеров."}},
