...
const std::unordered_map<std::string, Entry>& table() {
    static const std::unordered_map<std::string, Entry> t = {
        ...
        {"menu_hold", {"💎 Hold", "💎 Холд"}},
        {"hold_title", {"💎 <b>Hold</b>", "💎 <b>Холд</b>"}},
        {"hold_choose", {"Choose a wallet to see its current balance and the coins it holds:",
                         "Выберите кошелёк, чтобы посмотреть текущий баланс и монеты, которые он держит:"}},
