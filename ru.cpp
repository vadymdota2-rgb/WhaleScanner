...
const std::unordered_map<std::string, Entry>& table() {
    static const std::unordered_map<std::string, Entry> t = {
        ...
        {"hold_illiquid", {"⚠️ Marked tokens have no real market — thin pool or no liquidity at all. They are shown for reference and are NOT counted in the total.",
                           "⚠️ Отмеченные токены не имеют реального рынка — тонкий пул или ликвидности нет вовсе. Показаны для справки и в общую сумму НЕ входят."}},
        ...
        {"menu_big_trades", {"🔥 Biggest trades", "🔥 Крупные сделки"}},
        {"big_title", {"Biggest trades", "Крупные сделки"}},
        ...
        {"big_btn_spot", {"🟡 BSC Spot", "🟡 BSC Спот"}},
        {"big_btn_perp", {"🔵 Hyperliquid Futures", "🔵 Фьючерсы Hyperliquid"}},
        ...
        {"big_positions_btn", {"Positions", "Позиции"}},
        {"big_track_btn", {"Track", "Отслеживать"}},
        {"big_free_note", {"Free plan shows top 10 — Premium shows top 30.",
                           "На бесплатном плане — топ 10, с Премиум — топ 30."}},
