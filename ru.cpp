...
const std::unordered_map<std::string, Entry>& table() {
    static const std::unordered_map<std::string, Entry> t = {
        ...
        {"rk_unlock_top100", {"🔒 Unlock Top 1000 with Premium.", "🔒 Откройте Топ-1000 с Премиум."}},
        ...
        {"help_premium_3", {"• Full Top 1000 BSC spot traders (Top 30 is free)", "• Полный Топ-1000 трейдеров BSC Спот (Топ-30 бесплатно)"}},
        ...
        {"trial_granted", {"🎁 <b>7 days of Premium — on us</b>\n\nYou now have: Hyperliquid futures with ranking, alerts and open positions, up to 50 wallets, the full Top 1000 and priority alerts.\n\nGiven once per account.",
                           "🎁 <b>7 дней Премиума — в подарок</b>\n\nВам доступны: фьючерсы Hyperliquid с рейтингом, алертами и открытыми позициями, до 50 кошельков, полный Топ-1000 и приоритетные алерты.\n\nВыдаётся один раз на аккаунт."}},
        ...
        {"ton_paid_ok", {"✅ Payment received — Premium is active for 30 days.\n\nAll wallets, Hyperliquid futures and the full Top-1000 are back on.",
                         "✅ Оплата получена — премиум активен 30 дней.\n\nВсе кошельки, фьючерсы Hyperliquid и полный Топ-1000 снова включены."}},
