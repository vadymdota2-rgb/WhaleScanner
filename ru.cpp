...
const std::unordered_map<std::string, Entry>& table() {
    static const std::unordered_map<std::string, Entry> t = {
        ...
        {"fund_btn", {"💢 Anomalous funding", "💢 Аномальный фандинг"}},
        {"fund_title", {"Anomalous funding", "Аномальный фандинг"}},
        ...
        {"big_liq_loss", {"Loss", "Збиток"}},
        {"big_liq_position", {"Position", "Позиція"}},
        {"big_liq_closed_at", {"Closed at", "Закрито по"}},
        {"big_liq_account_was", {"Account was", "На рахунку було"}},
