...
const std::unordered_map<std::string, Entry>& table() {
    static const std::unordered_map<std::string, Entry> t = {
        ...
        {"ai_hint", {"We show what the wallets you follow are buying and selling. When many independent wallets move the same way, the model estimates the chance that the price follows within 24 hours.\n\nThe model also looks at the market: volatility and its spikes, trend, RSI, funding, open interest, liquidations, Bitcoin regime.\n\nA filter, not a forecast. Levels come from volatility, risk is a share of the deposit, not an order.", "Показываем, что покупают и продают кошельки, за которыми вы следите. Когда много независимых кошельков идут в одну сторону, модель оценивает шанс, что за сутки туда же пойдёт цена.\n\nМодель смотрит и на рынок: волатильность и её всплески, тренд, RSI, фандинг, открытый интерес, ликвидации, режим биткоина.\n\nЭто фильтр, а не прогноз. Уровни — от волатильности, риск — доля депозита, не приказ."}},
        {"ai_buy", {"Buy", "Покупка"}},
        ...
        {"ai_p_up", {"chance of a rise in 24h", "шанс роста за сутки"}},
